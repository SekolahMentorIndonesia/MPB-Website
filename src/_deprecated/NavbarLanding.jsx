...
export default function NavbarLanding() {
  ...
  const menuItems = [
    { name: t('header.nav.home'), href: '#hero' },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: 'Tentang PT', href: '#tentang-pt' },
      ...
      <div className={`lg:hidden fixed inset-0 z-50 transition-all duration-300 ${
        ...
        >
          ...
          <div className="p-5 border-t border-neutral-100 bg-neutral-50">
            <h4 className="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-3">{t('header.language')}</h4>
          ...
          <div className="p-5 border-t border-neutral-100 bg-white">
            <div className="flex flex-col items-center gap-3">
              <p className="text-sm text-neutral-500 text-center">
                © {new Date().getFullYear()} PT. Multiusaha Prioritas Bersama
              </p>
            </div>
          </div>
        </motion.div>
