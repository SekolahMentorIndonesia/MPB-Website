...
export default function Footer({ 
  ...
  const effectiveVariant = type === 'home' ? 'smi' : (variant || 'company');
  ...
  const getNavigationLinks = () => {
    ...
    // Company / Default
    return [
      { href: "#about", text: t('header.nav.about', { ns: 'landing' }) },
      { href: "#products", text: t('header.nav.products', { ns: 'landing' }) },
      { href: "#benefits", text: t('header.nav.benefits', { ns: 'landing' }) }
    ];
  };
