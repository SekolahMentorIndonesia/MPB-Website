...
function App() {
  ...
  // Social media links for Netranet
  const netranetSocialLinks = [
    { Icon: Instagram, url: 'https://www.instagram.com/netranet' }, // Placeholder URL
  ];

  // Navigation links for Netranet (simplified for this page)
  const netranetNavigationLinks = [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-xl font-semibold text-gray-800">Netranet – Product Showcase</h1>
          <a
      ...
      <section className="relative bg-neutral-900 py-20 md:py-32 overflow-hidden text-white">
        <div className="container mx-auto px-4 relative z-10 text-left">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl font-light">
            Kami menyediakan berbagai layanan teknologi inovatif untuk membantu bisnis Anda berkembang dan mencapai kesuksesan di era digital.
          </p>
          <a
            href="https://wa.me/6287744556696?text=Halo, saya tertarik dengan layanan Netranet"
            target="_blank"
      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          <div className="lg:w-2/3">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 lg:text-left text-center">Tentang Netranet</h2>
            <p className="text-gray-700 leading-relaxed mb-6 lg:text-left text-center max-w-prose mx-auto lg:mx-0">
              Netranet adalah penyedia solusi teknologi terkemuka yang berdedikasi untuk membantu bisnis mencapai potensi penuh mereka di era digital. Kami menawarkan berbagai layanan mulai dari infrastruktur jaringan, solusi cloud, hingga keamanan siber dan pengembangan perangkat lunak. Dengan tim ahli yang berpengalaman, kami berkomitmen untuk memberikan hasil yang inovatif dan efektif yang disesuaikan dengan kebutuhan unik setiap klien.
            </p>
          ...
          <div className="lg:w-1/3 flex justify-center">
            <img
              src="/images/company/2.webp" // Gambar Netranet
              alt="About Netranet"
      ...
      <footer className="bg-neutral-900 text-neutral-300 pt-16 lg:pt-24 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            {/* Column 1: Company Info (Netranet) */}
            <div className="flex flex-col items-start">
              <a href="/Product-Netranet" className="flex flex-col items-start mb-6 group">
                <span className="text-xl font-bold text-white leading-tight tracking-tight">Netranet</span>
                <span className="text-xs text-neutral-300 font-medium tracking-wide uppercase mt-0.5">Solusi Teknologi Terdepan</span>
              </a>
              <p className="text-sm leading-relaxed mb-8 font-sans text-neutral-300 max-w-xs">
                Netranet adalah penyedia solusi teknologi terkemuka yang berdedikasi untuk membantu bisnis mencapai potensi penuh mereka di era digital.
              </p>
              <div className="flex gap-4">
                {netranetSocialLinks.map(({ Icon, url }, i) => (
                  <a
                    key={i}
                    href={url}
                    target="_blank"
                    ...
                    aria-label={url.includes('instagram') ? 'Instagram Netranet' : `Social link ${i + 1}`}
                  >
            ...
            <div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <a href="mailto:info@netranet.com" className="text-sm hover:text-white transition-colors">info@netranet.com</a>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm font-sans mb-8">
                {netranetNavigationLinks.map((link, i) => (
                  <li key={i}>
          ...
          <div className="pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <p className="text-xs text-neutral-500 font-sans">
              &copy; {currentYear} Netranet. Hak Cipta Dilindungi.
            </p>
            <p className="text-xs text-neutral-600 font-sans flex items-center gap-1">
              <span>Dibuat dengan ❤️ oleh</span>
              <span className="text-neutral-500 font-medium">Tim Netranet</span>
            </p>
          </div>
        </div>
      </footer>
