...
function App() {
  ...
  // Social media links for Pusat Laptop Bekasi
  const iqiSocialLinks = [
    { Icon: Instagram, url: 'https://www.instagram.com/pusatlaptopbekasi' }, // Placeholder URL
  ];

  // Navigation links for Pusat Laptop Bekasi (simplified for this page)
  const iqiNavigationLinks = [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800">Pusat Laptop Bekasi – Product Showcase</h1>
          <a
            href="https://multipriority.com/" // Mengarahkan ke situs utama MPB Corps
            className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md flex items-center transition-colors duration-200 gap-2 flex-shrink-0"
          >
            <svg
      ...
      <section className="relative bg-neutral-900 py-20 md:py-32 overflow-hidden text-white">
        <div className="container mx-auto px-4 relative z-10 text-left">
          <h2 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 drop-shadow-lg">
            Pusat Laptop & Ponsel Terbaik di Bekasi
          </h2>
          <p className="text-lg md:text-xl mb-8 max-w-2xl font-light">
            Temukan berbagai pilihan laptop dan ponsel berkualitas tinggi dengan harga terbaik, serta layanan purna jual yang terpercaya.
          </p>
          <a
            href="https://wa.me/6287744556696?text=Halo, saya tertarik dengan layanan Pusat Laptop Bekasi"
            target="_blank"
      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          <div className="lg:w-2/3">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 text-left">Tentang Pusat Laptop Bekasi</h2>
            <p className="text-gray-700 leading-relaxed mb-6 text-left max-w-prose mx-auto lg:mx-0">
              Pusat Laptop Bekasi adalah destinasi utama Anda untuk menemukan laptop dan ponsel berkualitas tinggi di Bekasi. Kami menyediakan berbagai merek dan model terbaru, mulai dari laptop gaming, kerja, hingga ponsel pintar dengan spesifikasi beragam. Dengan komitmen pada kepuasan pelanggan, kami menawarkan produk asli, garansi terjamin, dan layanan purna jual yang responsif.
            </p>
            <ul className="space-y-3 text-gray-600 text-left">
              <li className="flex items-center gap-3">
                ...
                <span>Pilihan Laptop & Ponsel Terlengkap</span>
              </li>
              <li className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-brand-500 flex-shrink-0">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span>Harga Kompetitif & Garansi Resmi</span>
              </li>
              <li className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-brand-500 flex-shrink-0">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span>Layanan Purna Jual Terpercaya</span>
              </li>
            </ul>
          </div>
          <div className="lg:w-1/3 flex justify-center">
            <img
              src="/images/company/9.webp" // Gambar Pusat Laptop Bekasi
              alt="About Pusat Laptop Bekasi"
      ...
      <footer className="bg-neutral-900 text-neutral-300 pt-16 lg:pt-24 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            {/* Column 1: Company Info (Pusat Laptop Bekasi) */}
            <div className="flex flex-col items-start">
              <a href="/Product-Pusat-Laptop-Bekasi" className="flex flex-col items-start mb-6 group">
                <span className="text-xl font-bold text-white leading-tight tracking-tight">Pusat Laptop Bekasi</span>
                <span className="text-xs text-neutral-300 font-medium tracking-wide uppercase mt-0.5">Perdagangan Laptop & Ponsel</span>
              </a>
              <p className="text-sm leading-relaxed mb-8 font-sans text-neutral-300 max-w-xs">
                Pusat Laptop Bekasi adalah toko laptop terkemuka yang menyediakan berbagai pilihan laptop berkualitas tinggi untuk kebutuhan Anda.
              </p>
              <div className="flex gap-4">
                {iqiSocialLinks.map(({ Icon, url }, i) => (
                  <a
                    key={i}
                    href={url}
                    target="_blank"
                    ...
                    aria-label={url.includes('instagram') ? 'Instagram Pusat Laptop Bekasi' : `Social link ${i + 1}`}
                  >
          ...
          <div className="pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <p className="text-xs text-neutral-500 font-sans">
              &copy; {currentYear} Pusat Laptop Bekasi. Hak Cipta Dilindungi.
            </p>
            <p className="text-xs text-neutral-600 font-sans flex items-center gap-1">
              <span>Dibuat dengan ❤️ oleh</span>
              <span className="text-neutral-500 font-medium">Tim Pusat Laptop Bekasi</span>
            </p>
          </div>
        </div>
      </footer>
